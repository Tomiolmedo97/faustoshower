    ...
    <main className="relative mx-auto flex min-h-svh w-full max-w-lg flex-col items-center px-4 py-10 sm:px-6 sm:py-14">
      ...
      <article className="invite-card invite-hero paper-in relative w-full px-5 pb-11 pt-6 sm:px-10 sm:pb-12">
        ...
        <header className="mt-1 flex w-full flex-col items-center text-center">
          ...
          <h2
            className="mt-1 flex justify-center font-serif text-5xl font-medium text-brown uppercase sm:text-6xl"
      ...
      <Reveal delay={40}>
        <footer className="mt-10 mb-[env(safe-area-inset-bottom)] flex flex-col items-center gap-3 pb-6 text-center">
          <p className="script-heading text-[clamp(1.65rem,5vw,2.1rem)] text-sage/90">
            Con cariño
          </p>
          <Link
            to="/anfitriones"
